...
export const FullscreenImage = ({ src, alt, onClose, description }) => {
    // Let's log the props received by this component
    console.log("FullscreenImage received props:", { src, alt, description });
    ...
    return (
        <motion.div
            ...
            className="fixed inset-0 bg-white z-50 flex flex-col items-center justify-center cursor-zoom-out"
            onClick={onClose}
        >
            <img
                src={src}
            ...
            {description && (
                <motion.div
                    ...
                    className="mt-4 max-w-[600px] text-center font-sans italic text-[11px] px-4"
...
const WorkRow = ({ work }) => {
    ...
    // Let's log the work object to debug
    ...
    return (
        <div className="w-full py-12">
            <AnimatePresence>
                {fullscreenState && (
                    <FullscreenImage
                        src={fullscreenState.imageUrl}
                        alt={work.title || "Artwork"}
                        description={fullscreenState.description}
