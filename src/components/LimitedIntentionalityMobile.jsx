...
import MobilePhotoGrid from "@/components/MobilePhotoGrid.jsx";

const LimitedIntentionalityMobile = () => {
...
export default LimitedIntentionalityMobile;