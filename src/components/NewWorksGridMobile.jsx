...
export const WorkDisplayMobile = ({
                         work,
    ...
    return (
        <div className="w-full py-12">
            ...
            <div className="grid text-[10px] lg:text-[10px] mb-[8vw] uppercase font-bold font-alte-haas opacity-80 grid-cols-6 w-full">
...
export default WorksGridMobile;